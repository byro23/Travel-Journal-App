...
#Preview(as: .systemSmall) {
    ...
    SimpleEntry(date: .now, imageUrl: URL(string: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/Altja_j%C3%B5gi_Lahemaal.jpg/800px-Altja_j%C3%B5gi_Lahemaal.jpg"))
}
